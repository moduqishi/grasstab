                            ...
                            return (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div 
                                            className={`w-full h-full flex items-center justify-center text-white ${item.customIcon ? 'bg-white/5 shadow-lg' : item.color ? `bg-gradient-to-br ${item.color} shadow-lg` : ''} relative`}

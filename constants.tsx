    ...
    duckduckgo: {
        ...
        icon: (
            <svg viewBox="0 0 24 24" width="24" height="24" fill="none">
                ...
                <path d="M12 2C6.477 2 2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.879.617.113.844-.267.844-.593 0-.293-.011-1.066-.017-2.092-2.783.605-3.369-1.342-3.369-1.342-.561-1.424-1.369-1.803-1.369-1.803-1.119-.765.085-.75.085-.75 1.237.087 1.888 1.27 1.888 1.27 1.1 1.885 2.884 1.34 3.587 1.025.111-.797.43-1.34.781-1.648-2.736-.311-5.612-1.368-5.612-6.087 0-1.345.48-2.445 1.268-3.307-.127-.312-.55-1.562.12-3.256 0 0 1.034-.331 3.384 1.262a11.8 11.8 0 0 1 3.083-.415c1.046.005 2.099.141 3.083.415 2.35-1.593 3.382-1.262 3.382-1.262.671 1.694.248 2.944.121 3.256.79.862 1.267 1.962 1.267 3.307 0 4.731-2.88 5.773-5.623 6.076.442.38.835 1.13.835 2.277 0 1.645-.015 2.969-.015 3.372 0 .329.223.712.849.592C18.345 21.125 22 16.99 22 12c0-5.523-4.477-10-10-10z" fill="white"/>
                <ellipse cx="9.5" cy="10.5" rx="1.5" ry="2" fill="#2D4F8E"/>
                <ellipse cx="14.5" cy="10.5" rx="1.5" ry="2" fill="#2D4F8E"/>
                <path d="M8 14.5c0 .5.5 1 1 1h6c.5 0 1-.5 1-1" stroke="#2D4F8E" strokeWidth="1.5" strokeLinecap="round" fill="none"/>
                <path d="M12 16c1.5 0 2.5.5 3 1" stroke="#2D4F8E" strokeWidth="1" strokeLinecap="round" fill="none"/>
            </svg>
        )
    }
};
